...
const variants = [
  {
    ...
    component: ({ children, className, ...props }) => (
      <div
        {...props}
        className={cn(
          'relative rounded-xl bg-background px-1 py-1 ',
          className,
        )}
      >
        {children}
  ...
  },
  {
    ...
    component: ({ children, className, ...props }) => (
      <div
        {...props}
        className={cn(
          'relative rounded-xl border border-primary/10 bg-background px-4 py-5',
          className,
        )}
      >
        <div
      ...
      return (
        ...
        >
          ...
          <div
            {...props}
            className={cn(
              'relative select-none rounded-xl bg-background px-4 py-5',
              className,
            )}
          >
            {children}
