  ...
  return (
    <>
      <section className="min-h-[800px] w-full mt-0 relative overflow-hidden bg-gradient-to-br from-blue-50/80 via-indigo-50/60 to-purple-50/80 dark:from-slate-900 dark:via-blue-900/50 dark:to-indigo-900/50">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 md:px-10 pt-20 lg:pt-32">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="relative">
              <TooltipProvider>
                <MediaPlayer className="aspect-video w-full max-w-2xl mx-auto lg:mx-0">
                  <MediaPlayerVideo src="/demo-video.mp4" poster="/video-poster.jpg" />
                  <MediaPlayerControls>
                    <MediaPlayerPlay />
